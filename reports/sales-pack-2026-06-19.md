...
- Priority: S / Score: 97/100 / Category: ウェルネス/睡眠
- Source: Kicktraq Wearables <http://www.kicktraq.com/projects/burtran/burtran-smart-sleep-mask-recharge-in-minutes-anywhere/>
- Target: 睡眠の質や集中力を上げたい30〜50代のビジネス層、出張・旅行が多い層
- Price: 想定売価: 8,800〜24,800円。早割/セット割で初速を作る。
- LP headline: 忙しい毎日に、持ち運べるリカバリー習慣を。
- Ad angles: 外出・旅行・出張で使える携帯性 / 睡眠/集中/ストレスの悩み解決 / スマート機能による時短・自動化 / 海外クラファン発の先行入手感
- Japan validation: Makuakeで「持ち運び/省スペース/出張・旅行」訴求を検証
- Risks: 通常の輸入/PL保険/商標確認
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無
- Next action: Makuake/楽天/Amazon JP類似、卸条件、商標を確認

## 2. UKNIGHT: A Pixel Lantern Speaker for Your Desk

- Priority: A / Score: 86/100 / Category: ガジェット/家電
- Source: Kicktraq Gadgets <http://www.kicktraq.com/projects/1702789293/uknight-a-pixel-lantern-speaker-for-your-desk/>
- Target: 新しいデスク環境・スマート家電に反応する20〜40代のガジェット好き
- Price: 想定売価: 12,800〜39,800円。比較表と限定カラーで単価を上げる。
- LP headline: デスクの情報と道具を、ひとつの美しい体験に。
- Ad angles: スマート機能による時短・自動化 / ギフト・限定感・所有欲 / 海外クラファン発の先行入手感
- Japan validation: 睡眠/デスク環境/ウェルネスの悩み解決軸で検証
- Risks: 技適確認が必要
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無 / Bluetooth/Wi-Fi等の無線仕様、技適取得予定
- Next action: メーカーに技適/無線仕様と日本代理店有無を確認

## 3. HUBi32 – The Cyberpunk ESP32-S3 Smart Desk & Dev Hub

- Priority: A / Score: 86/100 / Category: ガジェット/家電
- Source: Kicktraq DIY Electronics <http://www.kicktraq.com/projects/bhawnacreator/hubi32/>
- Target: 新しいデスク環境・スマート家電に反応する20〜40代のガジェット好き
- Price: 想定売価: 39,800〜99,800円。CFでは強い実演動画と早割が必須。
- LP headline: デスクの情報と道具を、ひとつの美しい体験に。
- Ad angles: スマート機能による時短・自動化 / 海外クラファン発の先行入手感
- Japan validation: 睡眠/デスク環境/ウェルネスの悩み解決軸で検証
- Risks: PSE確認が必要
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無 / PSE対象可否、認証書類、同梱ACアダプタ仕様
- Next action: PSE対象可否、認証書類、ACアダプタ構成を確認

## 4. This Revolver-Style Titanium Driver’s Fidgety Design Is Both Eye and Hand Candy

- Priority: A / Score: 86/100 / Category: 工具/ホビー
...
- Target: DIY、クリエイター、クラフト、芝生管理など明確な趣味課題を持つ層
- Price: 想定売価: 8,800〜24,800円。早割/セット割で初速を作る。
- LP headline: 面倒な作業を、プロ仕様のスマート体験へ。
- Ad angles: 外出・旅行・出張で使える携帯性 / 海外クラファン発の先行入手感
- Japan validation: Makuakeで「持ち運び/省スペース/出張・旅行」訴求を検証
- Risks: 通常の輸入/PL保険/商標確認
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無
- Next action: Makuake/楽天/Amazon JP類似、卸条件、商標を確認

## 5. Pocket Shower: A Dual-Formula Reset for Anywhere

- Priority: B / Score: 83/100 / Category: 生活改善プロダクト
...
- Target: 日常の小さな不便を解決したいMakuake新商品好き
- Price: 想定売価: 8,800〜24,800円。早割/セット割で初速を作る。
- LP headline: 海外で注目される新しい便利さを、日本の暮らしへ。
- Ad angles: 外出・旅行・出張で使える携帯性 / 海外クラファン発の先行入手感
- Japan validation: Makuakeで「持ち運び/省スペース/出張・旅行」訴求を検証
- Risks: 通常の輸入/PL保険/商標確認
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無
...
## 6. EVERLITE 3-in-1 Outdoor Flashlight

- Priority: B / Score: 83/100 / Category: ガジェット/家電
- Source: Kicktraq Product Design <http://www.kicktraq.com/projects/23831970/everlite-3-in-1-outdoor-flashlight/>
- Target: 新しいデスク環境・スマート家電に反応する20〜40代のガジェット好き
- Price: 想定売価: 4,980〜14,800円。ギフト需要と複数購入セットが狙える。
- LP headline: 停電・キャンプ・日常をこれ一つで明るく整える。
- Ad angles: ギフト・限定感・所有欲 / 海外クラファン発の先行入手感
- Japan validation: Makuake類似成功例、Amazon JP競合、仕入れ可否を優先確認
- Risks: 通常の輸入/PL保険/商標確認
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無
- Next action: Makuake/楽天/Amazon JP類似、卸条件、商標を確認

## 7. FlexTorch Duo - The World's First Modular Flashlight
...
## 8. Magical Trainers Pocket! ✦ Vol.2 Satchel Bags & Mini bags
...
## 9. Twelvetooo Smart Projection Bulb: Light & Motion Anywhere

- Priority: B / Score: 82/100 / Category: ガジェット/家電
...
- LP headline: 停電・キャンプ・日常をこれ一つで明るく整える。
- Ad angles: スマート機能による時短・自動化 / ギフト・限定感・所有欲 / 海外クラファン発の先行入手感
- Japan validation: ガジェット好き・クリエイター・仕事効率化層で検証
- Risks: 通常の輸入/PL保険/商標確認
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無
- Next action: Makuake/楽天/Amazon JP類似、卸条件、商標を確認

## 10. Kinderbox – The Smart Audio Box for Children

- Priority: B / Score: 82/100 / Category: 生活改善プロダクト
...
## 11. PlantSenso — Turns plant care into play
...
## 12. MorningBlues SonicGlass A1 — Floating Lyric Speaker
...
## 13. Vimow: Wire-Free Vision AI Robot Lawn Mower
...
- Price: 想定売価: 39,800〜99,800円。CFでは強い実演動画と早割が必須。
- LP headline: 面倒な作業を、プロ仕様のスマート体験へ。
- Ad angles: 外出・旅行・出張で使える携帯性 / スマート機能による時短・自動化 / 海外クラファン発の先行入手感
- Japan validation: ガジェット好き・クリエイター・仕事効率化層で検証
- Risks: 通常の輸入/PL保険/商標確認
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無
- Next action: Makuake/楽天/Amazon JP類似、卸条件、商標を確認
...
- Priority: B / Score: 82/100 / Category: ファッション/アクセサリー
- Source: Kicktraq Product Design <http://www.kicktraq.com/projects/840192188/d1-milano-x-peter-tarka-the-impossible-watch/>
- Target: 人と被らない小物やギフトを探す20〜40代、推し活・デザイン雑貨好き
- Price: 想定売価: 12,800〜39,800円。比較表と限定カラーで単価を上げる。
- LP headline: 身につけるだけで会話が生まれる、まだ日本に少ないデザイン。
- Ad angles: ギフト・限定感・所有欲 / 海外クラファン発の先行入手感
- Japan validation: Makuake類似成功例、Amazon JP競合、仕入れ可否を優先確認
- Risks: 通常の輸入/PL保険/商標確認
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無
...
## 15. Lemoreleexpand: View Dock with Real-Time Status Display
...
## 16. 3I Atlas Space Terminal - Digital Life AI Companion Hub
...
## 17. Pest Memo: The Smart Bed Bug Detector That Gives Back
...
## 18. Rokibot G7: Ultimate AWD Robotic Mower for Challenging Lawns

- Priority: B / Score: 82/100 / Category: 工具/ホビー
...
## 19. Sou: Jewelry Wearable For Effortless Presence & Calm

- Priority: B / Score: 82/100 / Category: ウェルネス/睡眠
...
- Price: 想定売価: 8,800〜24,800円。早割/セット割で初速を作る。
- LP headline: 忙しい毎日に、持ち運べるリカバリー習慣を。
- Ad angles: 睡眠/集中/ストレスの悩み解決 / ギフト・限定感・所有欲 / 海外クラファン発の先行入手感
- Japan validation: Makuake類似成功例、Amazon JP競合、仕入れ可否を優先確認
- Risks: 食品衛生法・材質表示を確認
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無 / 食品接触材質、検査証明、材質表示の提出可否
- Next action: Makuake/楽天/Amazon JP類似、卸条件、商標を確認

## 20. StrokeKeeper: Your Golf Score Made Easy
...
- Price: 想定売価: 8,800〜24,800円。早割/セット割で初速を作る。
- LP headline: 海外で注目される新しい便利さを、日本の暮らしへ。
- Ad angles: 海外クラファン発の先行入手感
- Japan validation: Makuake類似成功例、Amazon JP競合、仕入れ可否を優先確認
- Risks: 通常の輸入/PL保険/商標確認
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無
- Next action: Makuake/楽天/Amazon JP類似、卸条件、商標を確認

## 21. Kieslect AI NotePods 10S: Earbuds with AI Meeting Summaries
...
## 22. DUSQ - The World’s Only Sleep Regulation System
...
- Price: 想定売価: 8,800〜24,800円。早割/セット割で初速を作る。
- LP headline: 忙しい毎日に、持ち運べるリカバリー習慣を。
- Ad angles: 睡眠/集中/ストレスの悩み解決 / 海外クラファン発の先行入手感
- Japan validation: 睡眠/デスク環境/ウェルネスの悩み解決軸で検証
- Risks: 通常の輸入/PL保険/商標確認
- First outreach questions: 日本での独占販売/先行販売の可否 / 卸価格、MOQ、初回納期、リードタイム / 既存の日本代理店・商標・販売制限の有無
- Next action: Makuake/楽天/Amazon JP類似、卸条件、商標を確認

## 23. Sychedelic Headphones: From Stress to Focus In Minutes
...
## 24. Atmos: Personal Air purifier built for real life
...
## 25. ILC1/7 VFD clock large Soviet vacuum fluorescent display DIY
...
## 26. Craftphilia: World's First Fully Automated Tufting Machine
...
## 27. Smart Joystick Controller -ESP32-S3 for Robotics & Gaming
...
## 29. Bruegel's Wearable Art: Enamel Pins, Pendants & Earrings
